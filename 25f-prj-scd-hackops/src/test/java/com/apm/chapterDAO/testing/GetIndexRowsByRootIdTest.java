...
public class GetIndexRowsByRootIdTest {

    private static Connection conn;
    private ChapterDAO chapterDAO;
    private BookDAO bookDAO;
    private AuthorDAO authorDAO;  // assuming you have this DAO
    private TokenDAO tokenDAO;    // for Token
    private LemmaDAO lemmaDAO;    // for Lemma
    private RootDAO rootDAO;      // for Root
    private SentenceDAO sentenceDAO;      // for Root
    ...
    void getIndexRowsByRootId_NoRows() {
        ArrayList<IndexRow> result = chapterDAO.getIndexRowsByRootId(999); // non-existent rootId
        assertTrue(result.isEmpty());
    }

    @Test
    @DisplayName("TP2: Two rows → returns correct IndexRow list")
    void getIndexRowsByRootId_TwoRows() throws Exception {
        // 1. Create Author
        ...
        // Call DAO function
        ArrayList<IndexRow> result = chapterDAO.getIndexRowsByRootId(1);
    ...
    void getIndexRowsByRootId_DBFailure() throws Exception {
