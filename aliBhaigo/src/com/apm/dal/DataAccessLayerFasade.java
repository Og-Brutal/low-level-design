...
public class DataAccessLayerFasade implements IDataAccessLayerFasade {
    ...
    public DataAccessLayerFasade(IBookDAO book, IAuthorDAO author,INgramDAO ngramDAO,ISentenceDAO sentence,
	...
	public boolean saveNgrams(int sentenceId, Set<String> ngrams) {
	    return ngramDAO.saveNgrams(sentenceId, ngrams);
	}

	public ArrayList<Integer> getCandidateSentenceIds(Set<String> ngrams) {
	    return ngramDAO.getCandidateSentenceIds(ngrams);
	}
    ...
    public String getSourcePath(int id) {
        // Delegate to SentenceDAO
        return sentence.getSourcePath(id);
    }
