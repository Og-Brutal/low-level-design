...
public class App {
	 ...
	 public static void main(String[] args) throws ClassNotFoundException, InstantiationException, IllegalAccessException, UnsupportedLookAndFeelException {
		...
		try {
			daf = new DataAccessLayerFasade(bookDAO,new AuthorDAO(conn,conn.createStatement()),new SentenceDAO(conn,conn.createStatement()),new ChapterDAO(conn,conn.createStatement()),new TextExtracter());
		} catch (SQLException e) {
			// TODO Auto-generated catch block
			e.printStackTrace();
		}
