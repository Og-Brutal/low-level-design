...
//    tabbedPane.addTab("Authors", authorPanel);
	...
	private JPanel createBrowsePanel() {
	    ...
	    return new MorphologicalBrowserPanel(BussinessLayerFasade);
	}
 ...
 // ==================== 📑 CHAPTERS PANEL ====================
   private void openChaptersPanel() {
    ...
    activeChaptersDialog = chapterDialog; // Store reference

    // ... [your existing openChaptersPanel() code] ...
    ...
    AnimatedButton oneTapChapterBtn = new AnimatedButton("📁 One-Tap Add Chapter", 
        new Color(106, 27, 154), new Color(142, 36, 170)) {
        @Override
        protected void paintComponent(Graphics g) {
            Graphics2D g2d = (Graphics2D) g;
    ...
    chapterList.addListSelectionListener(e -> {
        if (!e.getValueIsAdjusting()) {
            ...
            if (index >= 0 && finalChapters != null && index < finalChapters.size()) {
...
private void openSentencesPanel(JDialog parentDialog) {
    ...
    activeSentencesDialog = sentenceDialog; // Store reference

    // ... [your existing openSentencesPanel() code] ...
    ...
    final ArrayList<SentenceDTO> chapterSentences = new ArrayList<>();
    if (sentences != null) {
    ...
    // ===== Modern list with custom RTL renderer =====
    ...
    scrollPane.getViewport().setBackground(CARD_BG);
    scrollPane.getViewport().setComponentOrientation(ComponentOrientation.RIGHT_TO_LEFT);
    scrollPane.getViewport().setViewPosition(new Point(Integer.MAX_VALUE, 0));
