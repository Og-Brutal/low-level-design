...
// ** NEW METHOD FOR MORPHOLOGICAL LOOKUP **
	@Override
	public SegmentedTokenDTO getSegmentedTokenDetails(String tokenText) {
	    // CRITICAL FIX: Ensure you call the method on the ITokenBO instance (this.token), 
	    // passing the input string (tokenText).
	    return this.token.getSegmentedTokenDetails(tokenText); 
	}
