     ...
     // ===== Modern Icon + Text Header for Books Section =====
        JPanel titlePanel = new JPanel() {
            ...
            protected void paintComponent(Graphics g) {
                ...
                // 🎨 Aesthetic background gradient (soft blue to white)
                GradientPaint gp = new GradientPaint(
                        0, 0, new Color(220, 235, 255), // very light blue
                        getWidth(), getHeight(), new Color(245, 250, 255) // near white
                );
                g2.setPaint(gp);
        ...
        titlePanel.setBackground(new Color(240, 245, 255)); // soft pastel base

        JLabel listTitle = null; // ✅ Initialize

        try {
            // ✅ Load icon directly from bin
        ...
        // ===== Title Styling =====
        listTitle.setFont(new Font("Segoe UI Black", Font.PLAIN, 24)); // modern bold font
        listTitle.setForeground(new Color(25, 60, 120)); // deep professional blue
        listTitle.setBorder(new EmptyBorder(5, 10, 5, 10));
        ...
        // Then add this to your main panel:
        listCard.add(titlePanel, BorderLayout.NORTH);

        // ===== Add hover animation (changes brightness slightly) =====
        ...
        // Selection listener - deselect on click outside
        bookList.addListSelectionListener(new ListSelectionListener() {
            ...
            public void valueChanged(ListSelectionEvent e) {
                if (!e.getValueIsAdjusting()) {
                    ...
                    if (index >= 0) {
                        String bookTitle = bookListModel.getElementAt(index);
        ...
        bookList.addMouseListener(new MouseAdapter() {
            ...
            public void mousePressed(MouseEvent e) {
                ...
                if (bookList.locationToIndex(e.getPoint()) == -1) {
    ...
    private JList<String> createModernList(DefaultListModel<String> model) {
    	...
    	list.setCellRenderer(new DefaultListCellRenderer() {
    	    ...
    	    public Component getListCellRendererComponent(
    	        ...
    	        if (isSelected) {
    	            c.setBackground(new Color(PRIMARY.getRed(), PRIMARY.getGreen(), PRIMARY.getBlue(), 40));
