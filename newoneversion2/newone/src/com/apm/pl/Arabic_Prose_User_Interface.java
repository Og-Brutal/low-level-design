...
import com.apm.bll.TextProcessingUtil;
...
private void processSelectedChapterFile(java.io.File file, String bookName, JDialog parentDialog) {
  ...
  private void openSentencesPanel(JDialog parentDialog) {
    ...
    // ===== Custom Renderer for Right-Aligned Arabic Text =====
    sentenceList.setCellRenderer(new DefaultListCellRenderer() {
        ...
        public Component getListCellRendererComponent(JList<?> list, Object value,
            ...
            // Set Arabic-compatible font and right alignment
            label.setFont(new Font("Segoe UI", Font.PLAIN, 16));
            ...
            label.setBorder(BorderFactory.createCompoundBorder(
                    ...
                    BorderFactory.createMatteBorder(0, 0, 1, 0, separatorColor) // subtle separator
            ));
 ...
 // ==================== ✍️ AUTHORS PANEL ====================
    ...
    private void updateSentence() {
        ...
        if (result == JOptionPane.OK_OPTION) {
            ...
            String trans = transArea.getText().trim();
            String notes = notesArea.getText().trim();
            boolean isDeleted=BussinessLayerFasade.deleteTokensBySentence(text);
